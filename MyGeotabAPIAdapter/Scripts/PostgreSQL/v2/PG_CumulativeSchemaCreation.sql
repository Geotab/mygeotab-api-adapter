...
/*** [START] Version 4.0.1.0 Updates ***/
-- Only changing database version for consistency with
-- PG_4.0.1.0_spManagePartitionsFixes.sql.
/*** [END] Version 4.0.1.0 Updates ***/



/*** [START] Version 4.1.0.0 Updates ***/
-- Changes covered by PG_4.1.0.0_Upgrade.sql:
-- 1. spMerge_stg_Diagnostics2 self-heal logic included in function definition above.
-- 2. Users2 / stg_Users2: Added Designation column.
-- 3. spMerge_stg_Users2: Updated to include Designation in upsert logic.
-- 4. Devices2 / stg_Devices2: Added CustomProperties column.
-- 5. spMerge_stg_Devices2: Updated to include CustomProperties in upsert logic.
-- 6. Trips2 / stg_Trips2: Added EngineHours and Odometer columns.
-- 7. spMerge_stg_Trips2: Updated to include EngineHours and Odometer in upsert logic.
...
-- Update spMerge_stg_Users2 function to include Designation:
...
ALTER FUNCTION public."spMerge_stg_Devices2"(boolean) OWNER TO geotabadapter_client;
GRANT EXECUTE ON FUNCTION public."spMerge_stg_Devices2"(boolean) TO geotabadapter_client;
REVOKE ALL ON FUNCTION public."spMerge_stg_Devices2"(boolean) FROM PUBLIC;
-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
