...
DO $$	 
DECLARE 
    required_starting_database_version TEXT DEFAULT '3.14.0.0';
...
-- NOTE: This update only applies to SQL Server, but this script is
-- required for database version parity.
