...
--   from version 4.1.2.0 to version 5.0.0.0.
--
--   Changes:
--   1. Version bump only. Version 5.0.0.0 aligns the database version with the
--      application version following the addition of the Geotab DIG Adapter to
--      the solution. No schema changes are required.
--
-- NOTES:
...
INSERT INTO #TMP_UpgradeDatabaseVersionTable VALUES ('5.0.0.0');

DECLARE @requiredStartingDatabaseVersion NVARCHAR(50) = '4.1.2.0';
...
-- No schema changes required. This upgrade aligns the database version with
-- the application version following the addition of the Geotab DIG Adapter.
