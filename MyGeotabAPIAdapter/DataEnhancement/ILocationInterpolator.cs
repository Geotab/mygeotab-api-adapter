...
namespace MyGeotabAPIAdapter.DataEnhancement
{
    ...
    /// </summary>
    public interface ILocationInterpolator
    {
        /// <summary>
        ...
        /// <returns></returns>
        LocationInterpolationResult InterpolateCoordinates(DateTime targetDateTime, DateTime lagDateTime, double lagLongitude, double lagLatitude, DateTime leadDateTime, double leadLongitude, double leadLatitude, int numberOfCompassDirections);
    }
}
