...
namespace MyGeotabAPIAdapter.Services
{
    ...
    class TripProcessor : BackgroundService
    {
        ...
        /// </summary>
        public TripProcessor(IAdapterConfiguration adapterConfiguration, IAdapterEnvironment adapterEnvironment, IExceptionHelper exceptionHelper, IGenericEntityPersister<DbTrip> dbTripEntityPersister, IGenericGeotabObjectFeeder<Trip> tripGeotabObjectFeeder, IGeotabDeviceFilterer geotabDeviceFilterer, IGeotabTripDbTripObjectMapper geotabTripDbTripObjectMapper, IMyGeotabAPIHelper myGeotabAPIHelper, IPrerequisiteServiceChecker prerequisiteServiceChecker, IServiceTracker serviceTracker, IStateMachine stateMachine, IGenericDatabaseUnitOfWorkContext<AdapterDatabaseUnitOfWorkContext> adapterContext)
        {
        ...
        public override async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if (adapterConfiguration.EnableTripFeed == true)
            {
