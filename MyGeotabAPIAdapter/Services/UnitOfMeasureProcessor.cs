...
namespace MyGeotabAPIAdapter.Services
{
    ...
    /// </summary>
    class UnitOfMeasureProcessor : BackgroundService
    {
        ...
        /// <summary>
        /// Starts the current <see cref="UnitOfMeasureProcessor"/> instance.
        /// </summary>
        ...
        public override async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            adapterEnvironment.ValidateAdapterEnvironment(dbOserviceTrackings, AdapterService.UnitOfMeasureProcessor, adapterConfiguration.DisableMachineNameValidation);
            await asyncRetryPolicyForDatabaseTransactions.ExecuteAsync(async pollyContext =>
            {
                using (var adapterUOW = adapterContext.CreateUnitOfWork(Databases.AdapterDatabase))
                {
                    try
                    {
                        await serviceTracker.UpdateDbOServiceTrackingRecordAsync(adapterContext, AdapterService.UnitOfMeasureProcessor, adapterEnvironment.AdapterVersion.ToString(), adapterEnvironment.AdapterMachineName);
            ...
            if (adapterConfiguration.UseDataModel2 == false && adapterConfiguration.EnableUnitOfMeasureCache == true)
            {
        ...
        /// <summary>
        /// Stops the current <see cref="UnitOfMeasureProcessor"/> instance.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/>.</param>
        /// <returns></returns>
