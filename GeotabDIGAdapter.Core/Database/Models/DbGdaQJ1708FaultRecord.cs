...
{
    /// <summary>
    /// A class with properties that map to the columns of the gda.Q_J1708FaultRecords database table.
    /// </summary>
    [Table("gda.Q_J1708FaultRecords")]
    public class DbGdaQJ1708FaultRecord : IDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "gda.Q_J1708FaultRecords";
