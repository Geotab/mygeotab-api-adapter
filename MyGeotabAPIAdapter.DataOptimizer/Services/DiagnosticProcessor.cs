...
#nullable disable
                            ...
                            if (changedDbDiagnostics.Any())
                            {
                                ...
                                foreach (var changedDbDiagnostic in changedDbDiagnostics)
                                {
                                    ...
                                    var dbDiagnosticT = await dbDiagnosticTObjectCache.GetObjectByGeotabGUIDAsync(changedDbDiagnostic.GeotabGUIDString);
                                    ...
                                    else
                                    {
                                        ...
                                        var dbDiagnosticIdTs = await dbDiagnosticIdTObjectCache.GetObjectsAsync(changedDbDiagnostic.GeotabGUIDString, changedDbDiagnostic.GeotabId);
