            ...
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddTransient<UnitOfWorkContext>()
                            ...
                            .AddSingleton<IGenericDbObjectCache<DbDiagnostic>, GenericDbObjectCache<DbDiagnostic>>()
                            .AddSingleton<DbDiagnosticIdTObjectCache>()
                            .AddSingleton<IGenericDbObjectCache<DbDiagnosticT>, GenericDbObjectCache<DbDiagnosticT>>()
