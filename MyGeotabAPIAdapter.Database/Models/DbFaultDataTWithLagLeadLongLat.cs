...
{
    [Table("vwFaultDataTWithLagLeadLongLatBatch")]
    public class DbFaultDataTWithLagLeadLongLat : IDbEntity, IIdCacheableDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "vwFaultDataTWithLagLeadLongLatBatch";
