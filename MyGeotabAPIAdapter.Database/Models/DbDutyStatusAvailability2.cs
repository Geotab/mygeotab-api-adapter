...
{
    [Table("DutyStatusAvailabilities2")]
    public class DbDutyStatusAvailability2 : IDbEntity, IIdCacheableDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "DutyStatusAvailabilities2";
