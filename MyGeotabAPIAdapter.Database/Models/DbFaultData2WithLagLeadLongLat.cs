...
{
    [Table("spFaultData2WithLagLeadLongLatBatch")]
    public class DbFaultData2WithLagLeadLongLat : IDbEntity, IIdCacheableDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "spFaultData2WithLagLeadLongLatBatch";
