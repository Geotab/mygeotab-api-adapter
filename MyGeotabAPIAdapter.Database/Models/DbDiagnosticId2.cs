...
{
    [Table("DiagnosticIds2")]
    public class DbDiagnosticId2 : IDbEntity, IIdCacheableDbEntity, IGeotabGUIDCacheableDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "DiagnosticIds2";
