...
{
    [Table("Diagnostics2")]
    public class DbDiagnostic2 : IDbEntity, IIdCacheableDbEntity, IGeotabGUIDCacheableDbEntity, IStatusableDbEntity
    {
        /// <inheritdoc/>
        [Write(false)]
        public string DatabaseTableName => "Diagnostics2";
