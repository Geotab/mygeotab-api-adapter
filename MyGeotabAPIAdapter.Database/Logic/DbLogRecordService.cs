...
namespace MyGeotabAPIAdapter.Database.Logic
{
    ...
    public static class DbLogRecordService
    {
        ...
        /// <returns></returns>
        public static async Task<long> InsertAsync(ConnectionInfo connectionInfo, IEnumerable<DbLogRecord> dbLogRecords, DbConfigFeedVersion dbConfigFeedVersion, CancellationTokenSource cancellationTokenSource, int commandTimeout)
        {
