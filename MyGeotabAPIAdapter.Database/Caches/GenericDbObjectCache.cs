...
namespace MyGeotabAPIAdapter.Database.Caches
{
    ...
    public class GenericDbObjectCache<T> : IGenericDbObjectCache<T> where T : class, IIdCacheableDbEntity
    {
        ...
        /// </summary>
        public GenericDbObjectCache(IDateTimeHelper dateTimeHelper)
        {
        ...
        /// </summary>
        public GenericDbObjectCache(IDateTimeHelper dateTimeHelper, IBaseRepository2<T> testDbEntityRepo)
        {
            MethodBase methodBase = MethodBase.GetCurrentMethod();
            logger.Trace($"Begin {methodBase.ReflectedType.Name}.{methodBase.Name}");
