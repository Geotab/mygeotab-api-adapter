...
namespace MyGeotabAPIAdapter.Database.DataAccess
{
    ...
    public class DbFaultDataRepository : BaseRepository<DbFaultData>
    {
        ...
        /// <returns></returns>
        public async Task<long> InsertAsync(ConnectionInfo connectionInfo, List<DbFaultData> dbFaultDatas, DbConfigFeedVersion dbConfigFeedVersion, CancellationTokenSource cancellationTokenSource, int commandTimeout)
        {
