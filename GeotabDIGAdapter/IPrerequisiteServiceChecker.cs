...
namespace GeotabDIGAdapter
{
    ...
    {
        /// <summary>
        /// Checks whether all of the <paramref name="prerequisiteServices"/> are running and, if not, waits until they are. Intended to allow for any prerequisite services that are not running to be started and have dependent services then continue operation.
        /// </summary>
        ...
        /// <returns></returns>
        Task WaitForPrerequisiteServicesIfNeededAsync(string dependentServiceClassName, List<DIGAdapterService> prerequisiteServices, CancellationToken cancellationToken, bool includeCheckForWhetherServicesHaveProcessedAnyData = false);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/>.</param>
        Task WaitForPrerequisiteServiceToProcessEntitiesAsync(string dependentServiceClassName, DIGAdapterService prerequisiteService, CancellationToken cancellationToken);
    }
}
