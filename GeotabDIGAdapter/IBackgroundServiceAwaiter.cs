namespace GeotabDIGAdapter
{
    ...
    public interface IBackgroundServiceAwaiter<T> where T : BackgroundService
    {
        /// <summary>
        ...
        /// <summary>
        /// Waits for the restoration of connectivity to external APIs (DIG, MyAdmin) or to the adapter database if connectivity to any is lost, effectively pausing the subject service, <typeparamref name="T"/>.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/>.</param>
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/>.</param>
        /// <returns></returns>
        Task WaitForPrerequisiteServiceToProcessEntitiesAsync(DIGAdapterService prerequisiteService, CancellationToken cancellationToken);
    }
}
