...
{
    /// <summary>
    /// A class for obtaining environment information related to the GeotabDIGAdapter. 
    /// </summary>
    ...
    public class AdapterEnvironment<T> : IAdapterEnvironment<T> where T : IDbOServiceTracking
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdapterEnvironment{T}"/> class.
        /// </summary>
        ...
        /// <inheritdoc/>
        public void ValidateAdapterEnvironment(List<T> dbOServiceTrackings, DIGAdapterService adapterService, bool disableMachineNameValidation)
        {
